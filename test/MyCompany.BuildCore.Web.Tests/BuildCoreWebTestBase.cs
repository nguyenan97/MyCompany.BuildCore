...
{
    public abstract class BuildCoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BuildCoreWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BuildCoreWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BuildCoreDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BuildCoreDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BuildCoreDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BuildCoreDbContext, Task<T>> func)
        {
            T result;
