...
using MyCompany.BuildCore.Sessions;
using MyCompany.BuildCore.Web.Models.Account;
using MyCompany.BuildCore.Web.Views.Shared.Components.TenantChange;

namespace MyCompany.BuildCore.Web.Controllers
{
    public class AccountController : BuildCoreControllerBase
    {
